...
CREATE TABLE `order_service` (
  ...
  KEY `FK2dpyg00t5dup85hrr6m1ndkbj` (`order_id`),
  CONSTRAINT `FK2dpyg00t5dup85hrr6m1ndkbj` FOREIGN KEY (`order_id`) REFERENCES `service` (`service_id`),
  CONSTRAINT `FKlomlqcbq7pv9js34gd1mis5ba` FOREIGN KEY (`service_id`) REFERENCES `orders` (`order_id`)
...
INSERT INTO `order_service` VALUES (1,1),(2,1),(3,1);
