...
const HotelBookingDetailsCard = ({ hotelCode }) => {
  ...
  const roomOptions = [
    ...
    {
      value: '2 Queen Bed Standard Non Smoking',
      label: '2 Queen Bed Standard Non Smoking',
    },
    {
      value: '1 King Bed VIP View Sea',
      label: '1 King Bed VIP View Sea',
    }
  ];
  ...
  useEffect(() => {
    const getBookingDetails = async () => {
      const response = await fetch(`http://localhost:8080/api/room/${hotelCode}`);
      ...
      const data = {
        ...
        currentNightRate: bla.room_price,
        maxGuestsAllowed: bla.room_amountPeople,
